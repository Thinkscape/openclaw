...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.writeLock.timeoutMs": "Session Write Lock Timeout (ms)",
  "session.writeLock.backoffBaseMs": "Session Write Lock Backoff Base (ms)",
  "session.writeLock.backoffCapMs": "Session Write Lock Backoff Cap (ms)",
  "session.writeLock.backoffJitterMs": "Session Write Lock Backoff Jitter (ms)",
