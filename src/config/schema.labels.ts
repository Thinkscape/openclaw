...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "skills.load.promptPathAliases": "Skill Prompt Path Aliases",
  "skills.load.promptPathAliases[].from": "Skill Prompt Alias Source Prefix",
  "skills.load.promptPathAliases[].to": "Skill Prompt Alias Target Prefix",
  "skills.load.promptPathAliases[].when": "Skill Prompt Alias Scope",
  ...
  "agents.defaults.sandbox.docker.dangerouslyDisableNoNewPrivileges":
    "Sandbox Docker Disable No New Privileges",
  commands: "Commands",
  ...
  "session.writeLock": "Session Write Lock Tuning",
  "session.writeLock.timeoutMs": "Write Lock Timeout (ms)",
  "session.writeLock.backoffBaseMs": "Write Lock Backoff Base (ms)",
  "session.writeLock.backoffCapMs": "Write Lock Backoff Cap (ms)",
  "session.writeLock.backoffJitterMs": "Write Lock Backoff Jitter (ms)",
  ...
  "agents.list[].sandbox.docker.dangerouslyDisableNoNewPrivileges":
    "Agent Sandbox Docker Disable No New Privileges",
